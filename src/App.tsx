        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">RecipeSearch</h1>
                <p className="text-gray-600">Découvrez des recettes délicieuses</p>
              </div>
            </div>
            <button
            ...
            >
              {showFavorites ? 'Voir toutes les recettes' : `Mes favoris (${favorites.length})`}
            </button>
          </div>
        </div>
      </header>
          ...
          <div>
            ...
            {!loading && !error && recipes.length === 0 && searchTerm && (
              <div className="text-center py-12">
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 max-w-md mx-auto">
                  <p className="text-gray-600">Aucune recette trouvée pour "{searchTerm}"</p>
            ...
            {!loading && !error && searchTerm === '' && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 text-lg">Commencez votre recherche de recettes</p>
                <p className="text-gray-500">Tapez le nom d'un plat ou d'un ingrédient</p>
              </div>
            )}
